...
public class ProductDao {
   ...
   public static ArrayList<Product> getAllRecords(){
    ...
    public static void delete(String id) {
     ...
     public static ArrayList<String>getAllRecordsByCategory1(String category){
    ...
    public static ArrayList<String>filterProductByname1(String name,String category){
